...
def register():
    ...
    return jsonify({"message": "User registered successfully", "token": access_token, "email": email}), 201
...
def login():
    ...
    return jsonify({"message": "Login successful", "token": access_token, "email": email}), 200
